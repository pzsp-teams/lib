...
// TODO: tests should be adjusted to newest implementation/test-style
...
// func (f *fakeChannelResolver) ResolveChannelMemberRefToID(ctx context.Context, teamID, channelID, userRef string) (string, error) {
// 	f.lastTeamID = teamID
