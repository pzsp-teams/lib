...
//
//	mockgen --source=internal/api/channel.go --destination=internal/mocks/mock_channel_api.go --package=testutil
//
...
func (m *MockChannelAPI) SendMessage(ctx context.Context, teamID, channelID, content, contentType string) (models.ChatMessageable, *sender.RequestError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendMessage", ctx, teamID, channelID, content, contentType)
	ret0, _ := ret[0].(models.ChatMessageable)
	ret1, _ := ret[1].(*sender.RequestError)
	return ret0, ret1
}
...
func (mr *MockChannelAPIMockRecorder) SendMessage(ctx, teamID, channelID, content, contentType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMessage", reflect.TypeOf((*MockChannelAPI)(nil).SendMessage), ctx, teamID, channelID, content, contentType)
}
