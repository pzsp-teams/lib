...
func (mr *MockChannelAPIMockRecorder) AddMember(ctx, teamID, channelID, userRef, role any) *gomock.Call {
...
func (mr *MockChannelAPIMockRecorder) UpdateMemberRole(ctx, teamID, channelID, memberID, role any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
