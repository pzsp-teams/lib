...
//
//	mockgen --source=internal/api/chat.go --destination=internal/mocks/mock_chat_api.go --package=testutil
//
...
func (m *MockChatAPI) SendMessage(ctx context.Context, chatID, content, contentType string) (models.ChatMessageable, *sender.RequestError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendMessage", ctx, chatID, content, contentType)
	ret0, _ := ret[0].(models.ChatMessageable)
	ret1, _ := ret[1].(*sender.RequestError)
	return ret0, ret1
}
...
func (mr *MockChatAPIMockRecorder) SendMessage(ctx, chatID, content, contentType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMessage", reflect.TypeOf((*MockChatAPI)(nil).SendMessage), ctx, chatID, content, contentType)
}
