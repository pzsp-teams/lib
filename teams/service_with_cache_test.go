...
type fakeTeamAPI struct {
	...
	getMemberFunc         func(ctx context.Context, teamID, memberID string) (msmodels.ConversationMemberable, *snd.RequestError)
	...
	updateMemberRolesFunc func(ctx context.Context, teamID, memberID string, roles []string) *snd.RequestError
	...
	addMemberFunc         func(ctx context.Context, teamID string, member msmodels.ConversationMemberable) (msmodels.ConversationMemberable, *snd.RequestError)
	removeMemberFunc      func(ctx context.Context, teamID, memberID string) *snd.RequestError
	restoreDeletedFunc    func(ctx context.Context, deletedGroupID string) (msmodels.DirectoryObjectable, *snd.RequestError)
	listMembersFunc       func(ctx context.Context, teamID string) (msmodels.ConversationMemberCollectionResponseable, *snd.RequestError)
}
...
func (f *fakeTeamAPI) AddMember(ctx context.Context, teamID string, member msmodels.ConversationMemberable) (msmodels.ConversationMemberable, *snd.RequestError) {
	if f.addMemberFunc != nil {
		return f.addMemberFunc(ctx, teamID, member)
	}
	return nil, nil
}

func (f *fakeTeamAPI) RemoveMember(ctx context.Context, teamID, memberID string) *snd.RequestError {
	if f.removeMemberFunc != nil {
		return f.removeMemberFunc(ctx, teamID, memberID)
	}
	return nil
}

func (f *fakeTeamAPI) UpdateMemberRoles(ctx context.Context, teamID, memberID string, roles []string) *snd.RequestError {
	if f.updateMemberRolesFunc != nil {
		return f.updateMemberRolesFunc(ctx, teamID, memberID, roles)
	}
	return nil
}

func (f *fakeTeamAPI) GetMember(ctx context.Context, teamID, memberID string) (msmodels.ConversationMemberable, *snd.RequestError) {
	if f.getMemberFunc != nil {
		return f.getMemberFunc(ctx, teamID, memberID)
	}
	return nil, nil
}
...
func (f *fakeTeamAPI) ListMembers(ctx context.Context, teamID string) (msmodels.ConversationMemberCollectionResponseable, *snd.RequestError) {
	if f.listMembersFunc != nil {
		return f.listMembersFunc(ctx, teamID)
	}
	return nil, nil
}
